---
title: "Pod lupom: Kultura u medijima – Šta lokalne samouprave podržavaju?"
subtitle: "Kulturni centar Kaleidoskop"
author: "Autori: Duško Medić i Gordana Tadić-Novaković<br>"
date: "April 2023. godine<br>"
...
U nastavku donosimo detaljnu statističku analizu projekata koje su podržale lokalne samouprave.<br>


## ANALIZA MEDIJSKIH PROJEKATA U KULTURI (2015-2022) - LOKALNE SAMOUPRAVE
...
U periodu od 2015. godine do kraja juna 2022. godine na javnim konkursima sufinansiranja javnog interesa u sferi javnog informisanja lokalne samouprave ukupno su odobrile <b>`r sumaprojekatadinari` dinara</b> ili <b>`r sumaprojekataevri`  evra</b> za medijske projekte namenjene javnom informisanju u oblasti kulture.  U posmatranom periodu, ukupno je odobreno <b>`r brojpr` relevatnih projekata</b>. <br>
...
#### LOKALNE SAMOUPRAVE KOJE SU REALIZOVALE KONKURSE


```{r organ, echo=FALSE}

BrojORGAN <- brojprojekata 

BrojjedinstvenihOrgan <- n_distinct (BrojORGAN$`ORGAN`)

# Broj projekata prema produkciji
brojprOrgan <- BrojORGAN%>%
  group_by(`ORGAN`) %>%
    summarise(`BROJ PROJEKATA` = n()) %>%
  mutate()

#Podskup za kolicinu novca koja je ukupno data po produkciju za tabelu
novacgodOrgan <- BrojORGAN %>%
    group_by(ORGAN) %>%
  summarise(`EVRI` = sum(`EVRI`)) %>%
  mutate()
...
#Spajanje podataka
ORGAN = merge(x = brojprOrgan, y = novacgodOrgan, by = "ORGAN", all.x = TRUE)


TopOrgan <- ORGAN %>%      # Top N highest values by group
  arrange(desc(EVRI))
  #group_by( 'EVRI') %>%


ToppodORGAN <- TopOrgan[1,1] 
TopevriORGAN <- TopOrgan[1,3] 


TopORGANpr <- ORGAN %>%      # Top N highest values by group
  arrange(desc(`BROJ PROJEKATA`)) 
  #group_by( 'EVRI') %>%
  #slice(1:3)

ToppodprORGAN <- TopORGANpr[1,1] 
ToppodprbrojORGAN <- TopORGANpr[1,2]
TopevriprORGAN <- TopORGANpr[1,3] 

```
Ukupno <b>`r BrojjedinstvenihOrgan` lokalnih samouprava</b> je sprovodilo medijske konkurse čiji je cilj, između ostalog, bio i podizanje informisanosti građana u oblasti kulture. 
<br>
<br>
Najveći broj sredstava u posmatranom periodu, <b>ukupno `r TopevriORGAN` evra</b>, odobrila je  lokalna samouprava - <b>`r ToppodORGAN`</b>. Sa druge strane, najveći broj projekata u posmatranom periodu (<b>ukupno `r ToppodprbrojORGAN` projekata</b>), dodelila je  lokalna samouprava <b>`r ToppodprORGAN`</b>, i to u ukupnom iznosu od <b>`r TopevriprORGAN` evra</b>. 
<br>

```{r echo=FALSE}
datatable(TopOrgan, caption = 'Tabela 4: Ukupan broj produkcija i suma u evrima koja im je dodeljena u periodu 2015 - 30.jun 2022. godine', options = list(pageLength = 5))
...
Kao što smo već istakli, u posmatranom uzorku medijskih projekata, <b>lokalne samouprave</b> odobrile su  <b>ukupno `r sumaprojekataoblast` projekata čiji je cilj bio informisanje u kulturi</b>. Ukupna suma odobrena, <b>`r sumaprojekataevri`  evra</b>, odobrena je u periodu od 2015. do 30. juna 2022. godine.
...
<br>
<br>
LOKALNE SAMOUPRAVE za oblast AKTUELNA KULTURNA PRODUKCIJA najviše je odobrio sredstava za <b>podoblast `r JEZICI1[1,1]`</b>, ukupno <b>`r JEZICI1[1,3]` evra</b> za <b>`r JEZICI1[1,2]` projekata</b>.
<br>
<br>
...
LOKALNE SAMOUPRAVE za oblast MANIFESTACIJE odobrile su ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
...
<br>
<br>
LOKALNE SAMOUPRAVE za oblast MANIFESTACIJE najviše su odobrile sredstava za <b>podoblast `r JEZICI2[1,1]`</b>, ukupno <b>`r JEZICI2[1,3]` evra</b> za <b>`r JEZICI2[1,2]` projekata</b>.
<br>
<br>
...
LOKALNE SAMOUPRAVE za oblast KULTURNA BAŠTINA odobrile su ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
...
<br>
<br>
LOKALNE SAMOUPRAVE za oblast KULTURNA BAŠTINA najviše su odobrile sredstava za <b>podoblast `r JEZICI3[1,1]`</b>, ukupno <b>`r JEZICI3[1,3]` evra</b> za <b>`r JEZICI3[1,2]` projekata</b>.
<br>
<br>
...
```
LOKALNE SAMOUPRAVE za oblast OBRAZOVANJE odobrile su ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
...
<br>
<br>
LOKALNE SAMOUPRAVE za oblast OBRAZOVANJE najviše su odobrile sredstava za <b>podoblast `r JEZICI4[1,1]`</b>, ukupno <b>`r JEZICI4[1,3]` evra</b> za <b>`r JEZICI4[1,2]` projekata</b>.
<br>
<br>
...
```
LOKALNE SAMOUPRAVE za oblast DRUŠTVO odobrile su ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra. 
<br>
...
<br>
<br>
LOKALNE SAMOUPRAVE za oblast DRUŠTVO najviše su odobrile sredstava za <b>podoblast `r JEZICI5[1,1]`</b>, ukupno <b>`r JEZICI5[1,3]` evra</b> za <b>`r JEZICI5[1,2]` projekata</b>.
<br>
<br>
...
LOKALNE SAMOUPRAVE za oblast FILMSKO STVARALAŠTVO odobrile su ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra. 
<br>
...
LOKALNE SAMOUPRAVE za oblast MULTIKULTURALNOST odobrile su ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra. 
<br>
...
LOKALNE SAMOUPRAVE za oblast VIZEULNO STVARALAŠTVO odobrile su ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2015. do 30. juna 2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra.
<br>
